...
La radiación solar medida que inside en la atmósfera de nuestro planeta, alcanza los $1395 [W/{m}^{2}]$ este valor se denomina la \textbf{Constante Solar} y es un valor medio entre el valor máximo del \gloss{Perihelio} y el valor mínimo del \gloss{Afelio} (Ver glosario).\\
...
La radiación que inside sobre algun punto de la Tierra se denomina \gloss{gi}, esta radiación tiene 3 componentes: RadiacionDirecta Normal (\gloss{dni}), Radiación Difusa (\gloss{rd}) y Radiación Reflejada (ver Fig:\ref{fig:componentes}). \\ \box{$$ GI = DNI + Rdifusa + Rreflejada $$}

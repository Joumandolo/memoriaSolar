...
/* Volcar widget */
echo "
	<div style='position:absolute;top:0px;left:0px;width:228px;height:49px;background-image:url(".$url."images/hr.png)'>
		<div style='position:absolute;top:10px;left:80px;color:#8fc2ef;font-family:aero;font-weight:bold;font-size:14px'>".$unidad[1][0]."&nbsp;&nbsp;&nbsp;".round($radiacion[0])."&nbsp;&nbsp;&nbsp;".$unidad[1][1]."</div>
		<div style='position:absolute;top:26px;left:72px;color:#8fc2ef;font-family:aero;font-weight:normal;font-size:9px'>".$radiacion[1]." ".$unidad[0][0]."</div>
	</div>
	";
?>

...
/* Volcar widget */
echo "
	<div style='position:relative;width:228px;height:49px;background-image:url(http://".$url."/wp-content/plugins/solarMeteo/images/temp.png)'>
		<a href='http://".$url."/solarDatos/solarFch.php' style='display:block;height:100%;
width:100%;cursor:pointer;'></a>
		<div style='position:absolute;top:12px;left:70px;color:#f44949;font-family:aero;font-weight:bold;font-size:14px'>".$unidad[1][0]."&nbsp;&nbsp;&nbsp;".round($radiacion[0])."&nbsp;&nbsp;&nbsp;".$unidad[1][1]."</div>
		<div style='position:absolute;top:31px;left:72px;color:#f44949;font-family:aero;font-weight:normal;font-size:9px'>".$radiacion[1]." ".$unidad[0][0]."</div>
	</div>
	";
?>
